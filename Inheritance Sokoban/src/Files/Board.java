...
public class Board {
	...
	public ArrayList<Modification> getMods() {
		/*
		returns array list of modifications on board
		*/
		return this.mods;
	}
	...
	public Map<Integer, ArrayList<Location>> getLocs() {
		/*
		returns map of Integer representing coordiantes on 
		board to ArrayList of Location objects related to 
		all modifications at that coordinate
		*/
		return this.locs;
	}
	...
	public Map<Location, ArrayList<Modification>> getModLocs() {
		/*
		returns map of Location object to ArrayList of 
		Modifications associated with that Location
		*/
		return this.modLocs;
	}
	...
	public boolean notifyObservers(String cmd) {
		...
		*/
		for (Modification obs : this.mods) {	// change this to list of mods
