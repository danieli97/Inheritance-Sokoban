...
public class SokobanGUI extends JFrame implements ActionListener {
	...
	private Map<ImageIcon, JLabel> imageIcons; // list better?
	...
	public SokobanGUI() {
		...
		// add in a board method to get all the objects involved
		this.filename = "";
		this.levelMap = new HashMap<>();
		
		// change this to HashMap of icons and run through list of icons (going to need icon name and description)
		// loop through all the objects and create icons for each of them
		...
		/*
	 * ========================================================================
	 *  make a new draw function that draws based on the object that is passed 
	 * ========================================================================
	 */
	...
	/**
	 * ================================================================
	 *  replace these draw functions with a more general draw function 
	 * ================================================================
	 * 
	 * loop through objects list and 
	 * 
	 */
	
	private void drawAny(List<? extends Ambiguous> objects) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (moved) {
			b.setIcon(null);
			// for loop running through all movable or floor objects and redraw them using drawAny
			/* 
			 *  for (int i = 0; i < this.board.objectsArray.length(); i++) {
			 *  	objects = this.board.getObjects(objectsArray(i));
			 *  	this.drawAny(objects);
			 *  }
			 */
			this.drawStorage();
			this.drawBoxes();
